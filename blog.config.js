...
const BLOG = {
  ...
  //  https://caring-pineapple-cc3.notion.site/12dd743b2e93801f8124ca7c24e885c4?v=12dd743b2e938116bc99000c7038269d&pvs=4
  // 02ab3b8678004aa69e9e415905ef32a5
  
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '12dd743b2e93801f8124ca7c24e885c4,en:12dd743b2e93801f8124ca7c24e885c4',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'cooncn@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/0xCatKing', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/cloudclubchina', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  FONT_STYLE_TITLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-sans font-light',
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-serif font-light',
  // 字体CSS 例如 https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css
  FONT_URL: [
    'https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css',
    'https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,400..800;1,400..800&family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap'
  ],
  FONT_SANS: [
    '"Noto Sans"',
    '"LXGW WenKai"',
